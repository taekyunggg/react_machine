...
const Instructions = () => (
  <div className='instructions'>
    <p>
      ...
      <br />
      <br />
      To toggle playback, press the play button, or use the spacebar.  Each row represents
      a different instrument, and you can toggle sounds by clicking on individual squares.  The
